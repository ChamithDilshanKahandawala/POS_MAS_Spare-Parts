      ...
      {successSale && (
        <div className="modal-overlay">
          <div className="modal-box" style={{ maxWidth: '420px', textAlign: 'center' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr 1fr' : '1fr 1fr 1fr', gap: '8px', margin: '20px 0', textAlign: 'left' }}>
              ...
              {isAdmin && (
                <div style={{ background: 'rgba(16,185,129,0.1)', padding: '10px', borderRadius: '10px', gridColumn: isMobile ? '1/-1' : 'auto' }}>
                  <div style={{ fontSize: '9px', color: '#10b981' }}>Net Profit</div>
                  <div style={{ fontSize: '13px', fontWeight: 800, color: '#10b981' }}>{fmtRs(successSale.total_profit)}</div>
                </div>
              )}
            </div>
