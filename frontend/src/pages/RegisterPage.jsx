...
export default function RegisterPage() {
  ...
  // Senior Developer Tip: Reusable input wrapper style
  ...
  return (
    <div style={{
      ...
      background: 'radial-gradient(circle at top right, rgba(99,102,241,0.1), transparent), radial-gradient(circle at bottom left, rgba(220,38,38,0.05), transparent), var(--bg-primary)',
      padding: '20px'
    }}>
      <div className="animate-fade" style={{ width: '100%', maxWidth: '440px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <div style={{ 
            ...
            boxShadow: '0 10px 25px rgba(0,0,0,0.1)', border: '2px solid rgba(220,38,38,0.1)'
          }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '14px', marginTop: '4px' }}>
            Mudiyanse Auto Solutions · Internal Portal
          </p>
        </div>
        ...
        <div className="glass-card" style={{ 
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={inputWrapperStyle}>
              ...
              <select 
                className="input-field"
                style={{ paddingLeft: '44px', borderRadius: '12px', appearance: 'none', cursor: 'pointer' }}
                value={formData.shop} 
          ...
          {/* Guidelines */}
          <div style={{ 
            marginTop: '24px', padding: '12px', background: 'rgba(99,102,241,0.05)', 
            borderRadius: '12px', border: '1px dashed rgba(99,102,241,0.2)' 
          }}>
            <p style={{ fontSize: '11px', color: 'var(--text-muted)', display: 'flex', gap: '6px' }}>
              <CheckCircle2 size={14} style={{ color: '#6366f1', flexShrink: 0 }} />
              Registration requires manual approval by the administrator before you can sign in.
            </p>
          </div>
        </div>
